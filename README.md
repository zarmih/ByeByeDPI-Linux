...
4. Запустите приложение:
  ...
  **Как работает тестирование:**
  ...
  2. Через этот прокси делаются HTTPS-запросы ко всем выбранным сайтам (метод GET, без загрузки тела, с проверкой соединения и обработкой редиректов, согласно логике Android).
  3. В таблице отображается агрегированный результат: сколько сайтов открылось, процент успеха, среднее и медианное время ответа, количество таймаутов/ошибок, а также ETA и глобальный прогресс тестирования.
  ...
  6. Доступна пауза/возобновление (Pause/Resume) долгих тестов и полный экспорт/импорт результатов тестирования в JSON/CSV без необходимости повторного прогона.
