...
4. Запустите приложение:
  ...
  > **Важно:** Успешный HTTP-тест (`200 OK`) означает, что `ciadpi` смог соединиться с хостом, но **не гарантирует**, что этот метод надёжно обойдёт DPI-блокировки для всех сервисов в вашем браузере. Кроме того, помните, что это не VPN — ваш реальный IP-адрес не скрывается.
