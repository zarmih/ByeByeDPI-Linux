...
class HistoryDialog(QDialog):
    ...
    def on_export(self):
        ...
        try:
            bundle, _ = result_bundle.load_bundle(rec["filepath"])
    ...
    def on_compare(self):
        ...
        try:
            b1, _ = result_bundle.load_bundle(r1["filepath"])
            b2, _ = result_bundle.load_bundle(r2["filepath"])
    ...
    def on_delete(self):
        ...
        if reply == QMessageBox.Yes:
            result_bundle.delete_history_record(rec["filepath"], self.test_path)
            self.load_history()
